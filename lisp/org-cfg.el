...
;; adding tags to tasks when state is triggered
;; moving to canceled or waiting adds corresponding tags
;; moving to todo next done removes tags
;; hold adds waiting and hold tags
